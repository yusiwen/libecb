...
The valid range for C<count> is C<1> to the number of bits in the
underlying datatype minus one (7/15/31/63). If you need a rotate count
of zero you need to add an extra check before calling these functions
currently.
